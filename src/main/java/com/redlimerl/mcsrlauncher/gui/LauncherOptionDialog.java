...
public class LauncherOptionDialog extends JDialog {
    ...
    public JCheckBox devLoginCheckBox;
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        devLoginCheckBox = new JCheckBox();
        devLoginCheckBox.setText("(Beta Only) Enable Account Login Workflow with DevLogin");
        devLoginCheckBox.setToolTipText("This option is for test account logins before approved MCSRLauncher Azure Client by Mojang.");
        panel7.add(devLoginCheckBox, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
