...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        githubButton.setDoubleBuffered(false);
        githubButton.setEnabled(true);
        githubButton.setFocusPainted(true);
        githubButton.setHorizontalTextPosition(11);
        githubButton.setIcon(new ImageIcon(getClass().getResource("/icons/github.png")));
        githubButton.setIconTextGap(6);
        githubButton.setMargin(new Insets(5, 10, 5, 10));
        githubButton.setOpaque(false);
        githubButton.setRequestFocusEnabled(false);
        githubButton.setText("text.github");
        githubButton.setVerticalAlignment(0);
        githubButton.setVerticalTextPosition(0);
        launcherMenu.add(githubButton);
